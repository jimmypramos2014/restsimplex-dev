...
class DetalleVentaController extends Controller
{
    ...
    public function puntoVentaAction(Request $request)
    {
        ...
        $b64Doc = ($rutaPdf) ? chunk_split(base64_encode(file_get_contents($request->getSchemeAndHttpHost().'/'.$rutaPdf))) : '';
    ...
    public function newAction(Request $request)
    {
        ...
        if($formapago->getCodigo() == '5')
        {
            ...
            $this->container->get('AppBundle\Util\Util')->registrarCajaAperturaDetalle($caja_apertura_id,$monto_acuenta,'venta');
        ...
        if($formapago->getCodigo() != '5')
        {
            $this->container->get('AppBundle\Util\Util')->registrarCajaAperturaDetalle($caja_apertura_id,$pago_total,'venta');
    ...
    public function dataTableAction(Request $request)
    {
        ...
        $result = $this->container->get('AppBundle\Util\Util')->getFacturaVentaDT('v_factura_venta',$empresa);
